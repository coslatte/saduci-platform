...
export const predictionService = {
  ...
  createPrediction: async (patientId: string, predictionType: string): Promise<PredictionResult> => {
    return apiClient.post<PredictionResult>('/predictions', { patientId, predictionType });
  },
