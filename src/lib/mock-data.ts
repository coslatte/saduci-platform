import type { Patient, VitalSign, TimelineEvent } from '../features/patients/types';
...
export const mockPredictions: PredictionResult[] = [
  {
    ...
    factors: [
      ...
      { name: 'Lactate Level', value: 3.2, impact: 'negative', importance: 0.78 },
      { name: 'Blood Pressure', value: 118, impact: 'positive', importance: 0.65 },
    ],
    recommendation: 'Continue close monitoring. Consider early goal-directed therapy.',
  },
  {
    id: '2',
    patientId: '1',
    ...
    factors: [
      ...
      { name: 'Temperature', value: 38.4, impact: 'negative', importance: 0.76 },
      { name: 'Heart Rate', value: 110, impact: 'negative', importance: 0.71 },
    ],
    recommendation: 'High risk of sepsis. Initiate sepsis protocol immediately.',
  },
];
...
export const mockSimulations: Simulation[] = [
  {
    ...
    results: [
      { timestamp: new Date().toISOString(), metric: 'Mean Arterial Pressure', value: 75, status: 'normal' },
      { timestamp: new Date().toISOString(), metric: 'Cardiac Output', value: 5.2, status: 'normal' },
      { timestamp: new Date().toISOString(), metric: 'Urine Output', value: 45, status: 'warning' },
    ],
  },
  {
    id: '2',
